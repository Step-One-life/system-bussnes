...
import type { ClientPaymentType, LessonKind, PricingFormat, PricingRule } from '../model/types'
...
export function clientTypeToTuple(type: ClientPaymentType): RuleTuple {
  switch (type) {
    ...
    case 'unlimited_subscription':
      return { lessonKind: 'group', format: 'unlimited', durationMinutes: 60, sessionsCount: 0 }
  }
}
